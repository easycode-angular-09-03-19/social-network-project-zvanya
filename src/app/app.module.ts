...
// 2.2 Подключаете сервис GlobalAuth и в методе CanActivate вызываете геттер isLogin и если оне вернет true,
//     то возвращаете true если false, то редирект на логин
